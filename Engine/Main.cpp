...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"AssessmentSceneWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"AssessmentSceneWindowClass", L"Direct X Game Dev Template", WS_OVERLAPPEDWINDOW,
